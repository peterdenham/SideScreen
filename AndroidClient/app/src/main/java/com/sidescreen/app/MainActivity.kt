...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeDecoderForCurrentSurface() {
        ...
        val (surface, useTextureView) = activeVideoSurface() ?: run {
            mainDiag("initializeDecoder skipped — no valid ${if (shouldUseTextureView()) "TextureView" else "SurfaceView"} surface")
            return
        }
